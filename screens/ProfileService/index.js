			...
			<Container style={styles.main}>
				<View style={{flexDirection: 'column'}}>
					...
					<Header style={styles.header}>
						...
						<Text style={styles.textTitle}>Perfil del Servicio</Text>
						</Body>
			...
			<Container style={styles.main}>
				<View style={{flexDirection: 'column'}}>
					...
					<View style={styles.profileView}>
						...
						<Text style={styles.designtaionTxt}>{this.state.user.service_type_id == 1 ? "Paseador" : "Pet Sitter"}</Text>
					</View>
				...
				<Content style={styles.contentView}>
					<ScrollView style={styles.overlayContentBg}>
						...
						<View style={styles.cardBg}>
							...
							<Text style={styles.aboutLabelTxt}>DNI</Text>
							<Text style={styles.aboutDescriptionTxt}>
								{this.state.user.identification}
							</Text>

							{this.state.user.cuit && this.state.user.cuit != '' &&
							<View>
								<Text style={styles.aboutLabelTxt}>CUIT</Text>
								<Text style={styles.aboutDescriptionTxt}>
							...
							<Text style={styles.aboutLabelTxt}>Descripción General del Servicio</Text>
							<Text style={styles.aboutDescriptionTxt}>
								{this.state.user.short_description}
							</Text>

							<Text style={styles.aboutLabelTxt}>Descripción del Servicio para la Tarifa Básica</Text>
							<Text style={styles.aboutDescriptionTxt}>
								{this.state.user.basic_service_description}
							</Text>
